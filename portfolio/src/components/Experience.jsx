      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Work <span className="text-theme-500">Experience</span>
          </h2>
        ...
        <div className="max-w-5xl mx-auto space-y-8">
          {data.map((job, index) => (
            <Card 
              key={index}
              className="bg-[#1a1a1a] border-theme-500/20 p-8 hover:border-theme-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-theme-500/10 relative group"
            >
              {/* Timeline dot */}
              <div className="absolute -left-3 top-10 w-6 h-6 bg-theme-500 rounded-full border-4 border-[#0a0a0a] group-hover:scale-125 transition-transform"></div>
              ...
              <div className="space-y-3 mb-6">
                {job.highlights.map((highlight, idx) => (
                  <div key={idx} className="flex items-start gap-3 group/item">
                    <CheckCircle2 className="w-5 h-5 text-theme-500 flex-shrink-0 mt-0.5 group-hover/item:scale-110 transition-transform" />
